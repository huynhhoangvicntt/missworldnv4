  ...
  <table class="table table-striped table-bordered table-hover">
    ...
    <thead>
      <tr>
        ...
        <th style="width: 10%" class="text-nowrap">{LANG.onecat2_title}</th>
        <th style="width: 50%" class="text-nowrap">{LANG.description}</th>
        <th style="width: 10%" class="text-nowrap">{LANG.onecat2_image}</th>
          ...
          <div class="input-group">
            ...
            <span class="input-group-btn">
              <button
                ...
                type="button"
                onclick="get_onecat2_alias('{DATA.id}', '{NV_CHECK_SESSION}')"
              >
...
{DATA.description}</textarea
      ...
      <div class="form-group">
        <label class="col-sm-6 control-label" for="element_keywords"
          >{LANG.keywords}:</label
        >
        <div class="col-sm-18 col-lg-10">
          <input
